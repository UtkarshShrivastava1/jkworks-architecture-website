    ...
    <div className="min-h-screen w-full relative overflow-hidden"> 
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center lg:justify-start px-4 sm:px-6 lg:px-8">
        ...
        <div className="w-full max-w-md sm:max-w-lg lg:max-w-xl xl:max-w-2xl bg-black/40 backdrop-blur-lg p-6 sm:p-8 lg:p-10 shadow-2xl border border-white/20 lg:ml-8 xl:ml-16 2xl:ml-24 my-8 relative group transition-all duration-500 hover:shadow-3xl mt-24">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#b39069]/10 via-transparent to-[#b39069]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />
          
          <div className="relative z-10">
            {/* Professional Header */}
            <div className="mb-8">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-light mb-4 text-white tracking-wide">
                CONTACT US
              </h1>
              <div className="w-16 h-0.5 bg-[#b39069] mb-6 transition-all duration-500 group-hover:w-24" />
            ...
            <div className="space-y-6">
              ...
              <div className="relative group">
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    name="name"
                    className="w-full pl-12 pr-4 py-4 border border-gray-400 bg-white/5 backdrop-blur-sm text-white placeholder-gray-300 focus:border-[#b39069] focus:outline-none transition-all duration-300 focus:bg-white/10 focus:shadow-lg focus:shadow-[#b39069]/20"
                    value={form.name}
                    ...
                    required
                  />
                  <div className={`absolute bottom-0 left-0 h-0.5 bg-[#b39069] transition-all duration-300 ${focusedField === 'name' ? 'w-full' : 'w-0'}`} />
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                  />
                  <div className={`absolute bottom-0 left-0 h-0.5 bg-[#b39069] transition-all duration-300 ${focusedField === 'companyName' ? 'w-full' : 'w-0'}`} />
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                  />
                  <div className={`absolute bottom-0 left-0 h-0.5 bg-[#b39069] transition-all duration-300 ${focusedField === 'email' ? 'w-full' : 'w-0'}`} />
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="relative">
                  ...
                  />
                  <div className={`absolute bottom-0 left-0 h-0.5 bg-[#b39069] transition-all duration-300 ${focusedField === 'phone' ? 'w-full' : 'w-0'}`} />
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="relative">
                  ...
                  <textarea
                    name="message"
                    className="w-full pl-12 pr-4 py-4 h-32 border border-gray-400 bg-white/5 backdrop-blur-sm text-white placeholder-gray-300 focus:border-[#b39069] focus:outline-none transition-all duration-300 resize-none focus:bg-white/10 focus:shadow-lg focus:shadow-[#b39069]/20"
                    ...
                    required
                  />
                  <div className={`absolute bottom-0 left-0 h-0.5 bg-[#b39069] transition-all duration-300 ${focusedField === 'message' ? 'w-full' : 'w-0'}`} />
                </div>
              </div>
